                ...
                <div className="row">
                    <div className="col-lg-7 order-2">
                        <div className="newsletter-left">
                            ...
                            <span>Choose your necessary products from this feature categories</span>
